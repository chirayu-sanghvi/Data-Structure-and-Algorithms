/*
Coding Ninja: https://www.codingninjas.com/studio/problems/superior-elements_6783446?utm_source=striver&utm_medium=website&utm_campaign=a_zcoursetuf&leftPanelTabValue=PROBLEM
Problem statement
...
Time Limit: 1 sec
=========================== Solution Idea ==============================
Traverse the array from behind to keep track of the largest element till that iteration, and every time an element larger than the previous largest element is encountered, add it to the answer arraylist.
*/
import java.util.*;
