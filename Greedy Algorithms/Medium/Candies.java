/*
Coding Ninja: https://www.codingninjas.com/studio/problems/candies_893290
Leet Code: https://leetcode.com/problems/candy/description/
...
public class Solution {
    public static int requiredCandies(int[] students) {
        ...
        for(int i=n-2;i>=0;i--){
            if(students[i] > students[i+1] && result[i] < result[i+1]+1 ){
